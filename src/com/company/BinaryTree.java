...
public class BinaryTree {
    ...
    {
        //adds item to the root
        root = add(root, item);
    }

    private TreeNode add(TreeNode tree, String item)
    {
    ...
    public List<Object> Traversal()
    {
        ...
        Traversal(root, data, list);
        return data;
    }

    private void Traversal(TreeNode tree, List<Object> data, LinkedList<TreeNode> list)
    {
        while( tree!= null)
        {
            data.add(tree.getValue());
            if(tree.getRight() != null) {
                list.push(tree.getRight());
            }
            if(tree.getLeft() != null) {
                tree = tree.getLeft();
            }
